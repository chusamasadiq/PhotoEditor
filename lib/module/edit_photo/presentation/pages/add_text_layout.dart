...
Future<T?> addText<T>(
  ...
  DraggableWidgetTextChild? widgetToEdit,
]) async {
  return showDialog(
    context: context,
    useSafeArea: false,
...
class AddTextLayout extends StatefulWidget {
  ...
  final DraggableWidgetTextChild? widgetToEdit;
...
class _AddTextLayoutState extends State<AddTextLayout> {
  ...
  late ValueNotifier<DraggableWidgetTextChild> _valueListener;
  ...
  void initState() {
    ...
    _valueListener = ValueNotifier<DraggableWidgetTextChild>(
      widget.widgetToEdit ??
          ...
          Positioned.fill(
            child: Align(
              ...
              child: Padding(
                ...
                child: ValueListenableBuilder<DraggableWidgetTextChild>(
          ...
          Positioned(
            ...
            child: TextButton(
              onPressed: () {
                ...
                var result = DraggableWidgetTextChild(
