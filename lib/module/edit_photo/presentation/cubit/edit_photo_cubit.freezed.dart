...
mixin _$EditPhotoState {
  ...
  List<DraggableWidget> get widgets => throw _privateConstructorUsedError;
...
class _$_EditPhotoState implements _EditPhotoState {
  const _$_EditPhotoState({
    ...
    this.opacityLayer = 0,
    final List<DraggableWidget> widgets = const [],
  }) : _widgets = widgets;
  ...
  @override
  @JsonKey()
  List<DraggableWidget> get widgets {
...
abstract class _EditPhotoState implements EditPhotoState {
  const factory _EditPhotoState({
    final EditState editState,
    final double opacityLayer,
    final List<DraggableWidget> widgets,
  }) = _$_EditPhotoState;
